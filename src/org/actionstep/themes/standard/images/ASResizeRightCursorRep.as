...
/**
 * This class draws the right resizing cursor. 
 * 
 * @author Scott Hyndman
 */
class org.actionstep.themes.standard.images.ASResizeRightCursorRep extends NSImageRep 
{
	public function ASResizeRightCursorRep() 
	{
	...
	{
		return "ASResizeRightCursorRep(size=" + size() + ")";
	}
