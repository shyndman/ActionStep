...
/**
 * This class draws the highlighted (pressed) down arrow for the
 * <code>org.actionstep.NSScroller</code> class.
 * 
 * @author Richard Kilmer
 */
class org.actionstep.themes.standard.images.ASHighlightedScrollerDownArrowRep extends NSImageRep {
  
  public function ASHighlightedScrollerDownArrowRep() {
    m_size = new NSSize(9,9);
  }

  public function description():String {
    return "ASHighlightedScrollerDownArrowRep";
  }
