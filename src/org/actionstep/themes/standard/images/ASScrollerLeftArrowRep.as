...
/**
 * This class draws the unpressed left arrow for the
 * <code>org.actionstep.NSScroller</code> class.
 * 
 * @author Richard Kilmer
 */
class org.actionstep.themes.standard.images.ASScrollerLeftArrowRep extends NSImageRep {
  
  public function ASScrollerLeftArrowRep() {
    m_size = new NSSize(9,9);
  }

  public function description():String {
    return "ASScrollerLeftArrowRep";
  }
