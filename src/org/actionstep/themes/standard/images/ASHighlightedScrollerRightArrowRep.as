...
/**
 * This class draws the highlighted (pressed) right arrow for the
 * <code>org.actionstep.NSScroller</code> class.
 * 
 * @author Richard Kilmer
 */
class org.actionstep.themes.standard.images.ASHighlightedScrollerRightArrowRep extends NSImageRep {
  
  public function ASHighlightedScrollerRightArrowRep() {
    m_size = new NSSize(9,9);
  }

  public function description():String {
    return "ASHighlightedScrollerRightArrowRep";
  }
