 ...
 */
class org.actionstep.util.ASPostOrderEnumerator extends ASXmlEnumerator {
	 ...
	 */
	public function ASPostOrderEnumerator(aTree:XML, pref:Object) {
		super(aTree, pref);
	}
	...
	public function description():String {
		return "ASPostOrderEnumerator(tree=" + m_tree + ", pref=" + m_pref + ")";
	}
