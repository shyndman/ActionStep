...
/**
 * Handles the <code>inspectors</code> section of the AIB configuration file.
 * 
 * @author Scott Hyndman
 */
class org.aib.configuration.InspectorsSectionHandler extends AIBObject 
			...
			switch (child.nodeName)	{
				case "inspector":
					...
					AppSettings.addSettingWithSectionNameValue(
						ConfigSections.INSPECTORS, {type: type, src: src});
					break;
